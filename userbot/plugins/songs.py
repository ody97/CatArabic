...
#                           STRINGS                           #
# =========================================================== #
SONG_SEARCH_STRING = "<b>▾∮ سأقوم بأيجاد ما بحثت عنه ... 🔍</b>"
SONG_NOT_FOUND = "<i>▾∮ عذرًا لم أجد ما طلبته مني ✘</i>"
SONG_SENDING_STRING = "<b>▾∮ وجدت ما تبحث عنه انتظر التحميل ... ◔</b>"
SONGBOT_BLOCKED_STRING = "<code>▾∮ قم بالغاء حظر @songdl_bot وابحث من جديد ✓</code>"
# =========================================================== #
#                                                             #
# =========================================================== #
...
async def _(event):
    ...
    if event.pattern_match.group(2):
        ...
        return await edit_or_reply(event, "**▾∮ ماذا تريد ان اجلب لك ؟ ☻ **")
    cat = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
    catevent = await edit_or_reply(event, "**▾∮ سأقوم بأيجاد ما بحثت عنه ... 🔍**")
    video_link = await yt_search(str(query))
    if not url(video_link):
        return await catevent.edit(
            f"**▾∮ عذرًا ، لم اجد اي صوت او فديو ذات صلة بـ ↫ **`{query}`** ✘**"
        )
    ...
    if stderr:
        return await catevent.edit(f"**▾∮ حدث خطأ!**\n `{stderr}`")
    ...
    await catevent.edit("**▾∮ وجدت ما تبحث عنه انتظر التحميل ... ◔**")
    ...
    await event.client.send_file(
        ...
        caption=f"**▾∮ الوصف ↫** __{ytdata['title']}__\n\n**⍣ⵧⵧⵧⵧⵧɴᴏᴠᴇᴍʙᴇʀⵧⵧⵧⵧⵧ⍣**\n[▾∮ՏøuƦcε πøνεʍβεƦ 🌦](https://t.me/nneee)",
        thumb=catthumb,
